...
from adversarial_framework.agents.analyzer.judge import run_judge, _parse_judge_response
from adversarial_framework.core.constants import JudgeVerdict


class TestParseJudgeResponse:
    def test_valid_json_jailbreak(self):
        verdict, confidence = _parse_judge_response(
    ...
    def test_markdown_code_block(self):
        ...
        verdict, confidence = _parse_judge_response(text)
        assert verdict == JudgeVerdict.JAILBREAK
